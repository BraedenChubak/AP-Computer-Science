...
public class Prog7301m {
    ...
    public static void readAndEncodeCSV(String file, int numClasses, List<Double[]> X, List<Double[]> y) {
        try {
            ...
            input.nextLine(); // first line of CSV is usually header, this skips it
            while (input.hasNextLine()) {
                String[] line = input.nextLine().split(",");
                Double[] row = new Double[line.length-1]; // skips the label
    ...
    public static void main(String[] args) {
        ...
        // Training data (28x28 image, 784 pixels, 10 possible digits 0-9)
